...
\begin{figure}[ht] % ht
    \centering
    \includegraphics[width=2.5in]{WorkArchitecture.png}
...
automatically scales and load balances \cite{GAE}. Each micro-service is
written in Python using the Flask web framework \cite{Flask}:
