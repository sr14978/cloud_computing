...
application's needs since it is not critical data. Like every good database, it guarantees atomic
transactions and also it encrypts all data written to disk.
