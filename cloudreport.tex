...
Clang. The former is an example of a compiler that indeed runs multicore, which
would therefore not benefit from simple multi-threaded command line compilation
